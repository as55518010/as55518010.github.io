<template>
  <div id="avatar_area" class="panel-avatar-dec">
    <div class="avatar-area-wrap" @click="foucsMe">
      <router-link to="/author" tag="img" :src="avatarObj.avatar" />
      <!-- <router-link to="/author" tag="img" :src="avatarObj.avatar" :onerror="'this.src=\''+avatarObj.face+'\';this.onerror=null;'" /> -->
      <div class="panel-avatar-sign">
        <div class="name-wrap panel-aside-color">
          <span>{{ avatarName }}</span>
          <span class="icon iconfont angeldown1" />
        </div>
