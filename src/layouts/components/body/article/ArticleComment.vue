  ...
  <div id="articles_comment">
    <div>
      ...
      <div class="comment-textarea">
        <textarea id="comment_area_wrap" ref="refTextArea" v-model="commentBody" class="middle-base-scroll" />
      </div>
...
export default {
  ...
  methods: {
    ...
    createWrap: function(pre, pos) {
      const textAreaUtils = blogUtils.textAreaUtils
      const textInfo = textAreaUtils.getTextareaCursor(this.$refs.refTextArea)
