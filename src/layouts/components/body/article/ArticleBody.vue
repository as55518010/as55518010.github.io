<template>
  <div id="article_body">
    <article-title :article-info="articleInfo" @openFullScreenEven="openFullScreenEven" />
    <article-pre-line />
    <article-desc :article-obj="article" class="article-body-item" />
    <article-pre-pos :article-id="articleId" class="article-body-margin" />
    <article-comment ref="articleComment" class="article-body-item" :article-id="articleId" />
    <article-message class="article-body-item" :article-id="articleId" @noticeReplayEvent="noticeReplayEvent" @noticeQuoteEvent="noticeQuoteEvent" @noticeUpdateEvent="noticeUpdateEvent" />
  </div>
</template>
...
export default {
  ...
  methods: {
    openFullScreenEven: function() {
      this.BlogHeadBar.emit('openFullScreenEven', {
