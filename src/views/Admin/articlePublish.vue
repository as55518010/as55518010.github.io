<template>
  <div id="articlePublish">
    <div class="container">
      <h2>文章发布</h2>
      <p>文章标题：</p>
      <el-input v-if="isShow" v-model="publishDate.title" style="width:80%" placeholder="请输入内容" />
      <el-input v-else v-model="updateData.title" style="width:80%" placeholder="请输入内容" />
      ...
      <p>文章简介：</p>
      <el-input v-if="isShow" v-model="publishDate.brief" type="textarea" :rows="4" style="width:80%" placeholder="请输入文章简介..." />
      <el-input v-else v-model="updateData.brief" type="textarea" :rows="4" style="width:80%" placeholder="请输入文章简介..." />
      <p>文章主体内容：</p>
      ...
      <markdown ref="md" :toolbars-flag="true" :subfield="true" :default-open="'edit'" />
      <p>文章标签：</p>
      <el-input v-if="isShow" v-model="publishDate.label" style="width:200px" placeholder="请输入内容" />
      <el-input v-else v-model="updateData.label" style="width:200px" placeholder="请输入内容" />
      <p>文章分类：</p>
      <el-input v-if="isShow" v-model="publishDate.category" style="width:200px" placeholder="请输入内容" />
      <el-input v-else v-model="updateData.category" style="width:200px" placeholder="请输入内容" />
      <div class="event-Button">
        <el-button type="primary" @click="handeleClick">{{ btntext }}</el-button>
        <el-button v-show="!isShow" type="default" @click="handleCancel">取消</el-button>
      </div>
    </div>
