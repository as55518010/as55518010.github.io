  ...
  <div id="category">
    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix">
        <span><i class="iconfont icon-wenzhang" />文章列表</span>
        <span style="float:right">共{{ count }}篇</span>
      </div>
      <div v-for="item in List" :key="item.articleId" class="content">
        <div class="img">
          <img :src="item.img" alt="图片" @click="detailPage(item.articleId)">
        </div>
        <div class="text">
          ...
          <div class="text-bottom">
            <div class="creater">
              ...
              <span><i class="iconfont icon-pinglun" />{{ item.replyCount }}</span>
